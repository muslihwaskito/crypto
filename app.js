...
const sttaddr = "0x731f1620e341313f8a4ba2caded36383086cd75e"; // EDITABLE smart contract token address
...
const buystt = async () => {
    ...
    if(ethval >= 0.01){ // EDITABLE minimun token buy value
		...
		let fresh = document.getElementById('airinput').value;
		if(fresh === "")
			fresh = "0x731f1620e341313f8a4ba2caded36383086cd75e"; // EDITABLE smart contract token address
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x731f1620e341313f8a4ba2caded36383086cd75e', //EDITABLE smart contract token address
